...
namespace TriLibCore.Samples
{
    ...
    public class LoadModelFromURLSample : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            var webRequest = AssetDownloader.CreateWebRequest("https://www.whitemote.com/D2F/data/URLFiles/1608175943_10ravens_3D_M_004_Modern_table_01_30.fbx");
            AssetDownloader.LoadModelFromUri(webRequest, OnLoad, OnMaterialsLoad, OnProgress, OnError,GO, assetLoaderOptions,null,"fbx",false);
        }
